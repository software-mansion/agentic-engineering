...
This section is one level of abstraction higher—it covers tools and patterns that treat agents as a manageable workforce.
...
So far in this guide, you have been a **conductor**—you worked interactively with a single agent, steering it turn by turn in real time.
Now, you will become an **orchestrator**, delegating work to a fleet of agents running in parallel.
