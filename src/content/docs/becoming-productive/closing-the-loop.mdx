...
- **Make `--help` useful.** Include examples in every subcommand's help output.
...
- **Use a predictable command structure.** Pick a pattern (e.g. resource + verb) and use it everywhere.
