...
<ClapButton slug="getting-started/how-to-set-up-a-new-repo/gathering-knowledge" />
...
<ClapButton slug="getting-started/how-to-set-up-a-new-repo/a-first-commit-in-8-steps" />
...
<ClapButton slug="getting-started/how-to-set-up-a-new-repo/a-first-bug-fixed-in-7-steps" />
...
<ClapButton slug="getting-started/how-to-set-up-a-new-repo/a-first-design-implemented-in-4-steps" />
