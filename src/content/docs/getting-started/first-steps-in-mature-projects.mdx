...
In <ExternalLink href="https://github.com/Expensify/App">Expensify</ExternalLink>, tasks can be created inside reports (chats), but there was no single
...
Where to put these? Often in your own skills. They can also be a `Makefile`, a <ExternalLink href="https://just.systems/man/en/">`justfile`</ExternalLink>, or just a gitignored `local/` directory with a bunch of `*.sh` scripts.
